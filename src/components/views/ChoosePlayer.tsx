    ...
    <div className="bg-muted relative h-screen w-screen overflow-hidden">
      {touches.length === 0 && (
        <>
          ...
          <Button
            size="lg"
            className="bg-muted-foreground text-primary-foreground hover:bg-muted-foreground absolute bottom-1/8 left-1/2 z-99 -translate-x-1/2 transform select-none hover:opacity-90 active:scale-[.98]"
            onClick={onSkipClick}
          >
            Skip
          </Button>
